...
public class EmployeeResourceTest {
    ...
    public static WebArchive createDeployment() {
        ...
        return ShrinkWrap.create(WebArchive.class, "jee-flywaydb.war")
    ...
    public void setUp() throws MalformedURLException {
        ...
        target = client.target(URI.create(new URL("http://localhost:8080/jee-flywaydb/resources/employee").toExternalForm()));
